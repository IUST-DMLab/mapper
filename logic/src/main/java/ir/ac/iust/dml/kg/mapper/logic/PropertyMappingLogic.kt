...
class PropertyMappingLogic {
          ...
          if (classMapping != null) {
            ...
            if (exact.data.isNotEmpty()) {
              ...
              if (l.isNotEmpty() && l.size < 4) {
                ...
                mapping.ontologyProperty = URIs.generateOntologyPropertyPrefixed(rawProperty, "dbo")
              dao.save(mapping)
            }
          }
        } catch (e: Throwable) {
  ...
  fun predicateExport(page: Int, pageSize: Int, keyword: String?,
    ...
    val uniqueProperties = dao.listUniqueProperties(page, pageSize, "fa", keyword, ontologyClass,
        templateName, status, language)
